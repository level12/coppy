...
Our [Changelog] is intended to be a helpful resource for maintainers of Coppy projects.
Make sure you review it, especially the **Breaking** section of each release, before
upgrading to the latest Coppy template (see next section).


## Template Updates

[Copier], the project Coppy is built on, enables code lifecycle management for generated
projects. That means, it's much easier to keep your project
[in-sync with the upstream template] even when you have made changes to the template files
post-generation.

Before [updating] your Coppy based project, check the [Changelog] for breaking changes.
We'll do our best to keep them relatively minor and provide clear instructions when manual
...
- Testing
    ...
    - [`pytest`](https://docs.pytest.org/en/stable/) with
      [integrated](https://pypi.org/project/pytest-cov/) code
